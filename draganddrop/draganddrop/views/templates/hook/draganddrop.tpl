		...
		<div id="htmlcontent_top">
			<ul class="htmlcontent-home clearfix row">
				<li id="dnd-top-right">
					...
					<div id="dnd-right-text">Cliquez sur un élément de l'image pour le verrouiller</div>
					<div id="dnd-right-price"></div>
				</li>
				<li id="dnd-bottom-right">
					<div id="dnd-caddie"><img src="http://monkeyisback.com/shop/modules/draganddrop/img/kdi.jpg" /></div>
